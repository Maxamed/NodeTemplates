...
History = (function() {
  ...
  History.prototype._resource = function(url, method, data, headers) {
    var Path, document, jsdom_opts, referer, _ref, _ref1,
      _this = this;
    jsdom_opts = {
      deferClose: true,
      features: {
    ...
    this._window.document = document;
    document.window = document.parentWindow = this._window;
    this._window.navigator.userAgent = this._browser.userAgent;
    switch (url.protocol) {
      case "about:":
  ...
  History.prototype.go = function(amount) {
    var entry, evt, new_index, was, _ref, _ref1, _ref2;
    ...
    if (new_index !== this._index && (entry = this._stack[new_index])) {
      ...
      if (entry.pop) {
        if (this._window.document) {
          ...
          this._browser.dispatchEvent(this._window, evt);
        }
